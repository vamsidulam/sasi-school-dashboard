...
/**
 * Generic delete-confirmation dialog. Pass in:
 *   open       — boolean
 *   title      — e.g. "Delete student"
 *   itemLabel  — text or React node naming the thing being deleted
 *   onCancel
 *   onConfirm  — async; errors are caught and surfaced
 */
      ...
      >
        ...
        <div className="px-5 py-4 text-sm text-gray-700">
          <p>
            ...
            {itemLabel ? <span className="font-semibold text-gray-900">{itemLabel}</span> : 'this item'}?
          </p>
