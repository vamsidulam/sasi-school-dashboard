...
export default function ConfirmDeleteDialog({ open, exam, onCancel, onConfirm }) {
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="confirm-delete-exam-title"
      ...
      >
        <header className="flex items-center justify-between border-b border-gray-200 px-5 py-3">
          <div className="flex items-center gap-2">
            ...
            <h2 id="confirm-delete-exam-title" className="text-base font-semibold text-gray-900">
              Delete exam
            </h2>
          </div>
          <button
