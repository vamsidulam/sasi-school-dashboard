...
export default function ConfirmDeleteDialog({ open, branch, onCancel, onConfirm }) {
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="confirm-delete-branch-title"
      ...
      >
        <header className="flex items-center justify-between border-b border-gray-200 px-5 py-3">
          <div className="flex items-center gap-2">
            ...
            <h2 id="confirm-delete-branch-title" className="text-base font-semibold text-gray-900">
              Delete branch
            </h2>
          </div>
          <button
        ...
        <div className="px-5 py-4 text-sm text-gray-700">
          <p>
            ...
            <span className="font-mono text-xs text-gray-500">({branch.code})</span>?
          </p>
