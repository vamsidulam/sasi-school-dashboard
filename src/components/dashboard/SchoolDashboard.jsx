...
import { ArrowLeft, Users, BarChart3, Award, AlertTriangle } from 'lucide-react'
...
import { CLASS_DATA, STATE_CLASS_RANKS } from './dummyData.js'
    ...
    <div className="space-y-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">
          Class-wise performance analysis and branch rankings
        </p>
      </div>
