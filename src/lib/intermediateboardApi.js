const BASE = import.meta.env.VITE_INTERMEDIATE_BOARD_DASHBOARD_URL

if (!BASE && import.meta.env.DEV) {
  console.warn(
    '[intermediateboardApi] VITE_INTERMEDIATE_BOARD_DASHBOARD_URL is not set — API calls will fail.',
  )
}
